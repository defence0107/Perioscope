...
parser.add_argument('--upper', type=int, default=1500, help='')
parser.add_argument('--lower', type=int, default=-300, help='')
...
parser.add_argument('--valid_rate', type=float, default=0.4, help='')


# data in/out and dataset
parser.add_argument('--dataset_path', default=r'D:/project/raw_dataset/fixed.list', help='fixed trainset root path')
parser.add_argument('--test_data_path', default=r'D:/project/raw_dataset/test', help='Testset path')
parser.add_argument('--save', default='Result', help='save path of trained model')
parser.add_argument('--batch_size', type=list, default=1, help='batch size of trainset')

# train
parser.add_argument('--epochs', type=int, default=8000, metavar='N',help='number of epochs to train (default: 200)')
parser.add_argument('--lr', type=float, default=0.0001, metavar='LR',help='learning rate (default: 0.0001)')
parser.add_argument('--early-stop', default=5, type=int, help='early stopping (default: 30)')
...
parser.add_argument("--use-amp", action="store_true", help="是否使用混合精度训练")
